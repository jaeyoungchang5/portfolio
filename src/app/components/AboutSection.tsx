	...
	return (
		<section className='mt-4' id='about'>
			<div className="grid grid-cols-1 md:grid-cols-12">
                <div className="col-span-4 md:order-last rounded-full bg-[#181818] w-[250px] h-[250px] lg:w-[350px] lg:h-[350px] relative">
                    <Image
                ...
                <div className='col-span-8 place-self-center text-center sm:text-left justify-self-start'>
                    ...
                    <p className='text-slate-200 text-left pb-4 text-base lg:text-lg'>
